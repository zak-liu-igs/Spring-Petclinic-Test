...
String firstName = 'EditNav' + token.substring(token.length() - 6)
...
def createOwner = {
    ...
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Address'), '212 Edit Road')
