...
""", null)
    ...
    WebUI.verifyElementPresent(xpath('escaped text-only pet name',
        "//dd[normalize-space(.)='" + petName + "' and not(.//*)]"), 10)
    WebUI.verifyElementNotPresent(xpath('injected bold element',
        "//dd[normalize-space(.)='" + petName + "']//b"), 2)
    WebUI.verifyElementPresent(xpath('escaped lizard details',
