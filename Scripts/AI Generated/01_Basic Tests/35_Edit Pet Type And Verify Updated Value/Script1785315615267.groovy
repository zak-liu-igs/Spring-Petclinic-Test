...
String firstName = 'EditPetTypeFirst' + stamp
String lastName = 'EditPetTypeLast' + stamp
String address = stamp + ' Edit Pet Type Street'
String city = 'EditPetTypeCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'TypePet' + stamp
String birthDate = '2024-01-01'
String originalType = 'dog'
String updatedType = 'cat'
...
""", null)
    ...
    WebUI.selectOptionByValue(findTestObject('Page_PetClinic  a Spring Framework demonstration/select_Type'), originalType, false)
    ...
    WebUI.verifyTextPresent(originalType, false)
...
""", null)
    ...
    WebUI.selectOptionByValue(findTestObject('Page_PetClinic  a Spring Framework demonstration/select_Type'), updatedType, false)
    ...
    WebUI.verifyTextPresent(updatedType, false)
} finally {
    WebUI.closeBrowser()
}
