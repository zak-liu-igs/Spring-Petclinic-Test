...
String firstName = 'Zero' + token.substring(token.length() - 6)
String lastName = 'Phone' + token.substring(token.length() - 7)
String telephone = '0' + token.substring(token.length() - 9)
...
try {
    ...
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Address'), '119 Leading Zero Way')
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_City'), 'Nantou')
