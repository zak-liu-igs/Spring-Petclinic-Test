...
String firstName = 'Blank' + stamp
String lastName = 'WB' + stamp
String address = stamp + ' Whitespace Street'
String city = 'BlankCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'Space' + stamp
...
""", null)
    ...
    WebUI.waitForElementVisible(newVisitHeading, 10)
    ...
    WebUI.verifyTextPresent('must not be blank', false)
    ...
    WebUI.verifyElementVisible(findTestObject('Page_PetClinic  a Spring Framework demonstration/button_Add Visit'))
} finally {
    WebUI.closeBrowser()
}
