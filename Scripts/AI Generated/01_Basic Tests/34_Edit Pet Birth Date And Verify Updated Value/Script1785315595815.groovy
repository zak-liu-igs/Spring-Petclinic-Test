...
String firstName = 'EditPetDateFirst' + stamp
String lastName = 'EditPetDateLast' + stamp
String address = stamp + ' Edit Pet Date Street'
String city = 'EditPetDateCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'DatePet' + stamp
