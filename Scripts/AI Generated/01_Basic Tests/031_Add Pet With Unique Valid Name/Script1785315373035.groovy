...
String firstName = 'PetFirst' + stamp
String lastName = 'PetLast' + stamp
String address = stamp + ' Pet Street'
String city = 'PetCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'Pet' + stamp
...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Address'), 10)

    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Address'), address)

    WebUI.waitForElementVisible(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_City'), 10)

    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_City'), city)

    WebUI.waitForElementVisible(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Telephone'), 10)
