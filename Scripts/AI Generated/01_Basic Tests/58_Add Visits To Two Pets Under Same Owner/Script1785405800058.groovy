...
String firstName = 'TwoPets' + stamp
String lastName = 'TP' + stamp
String address = stamp + ' Two Pets Street'
String city = 'TwoPetsCity'
String telephone = stamp.substring(stamp.length() - 10)
String firstPetName = 'Ruby' + stamp
String secondPetName = 'Milo' + stamp
String firstVisitDescription = 'Ruby visit ' + stamp
String secondVisitDescription = 'Milo visit ' + stamp
...
TestObject secondPetAddVisitLink = new TestObject('secondPetAddVisitLink')
secondPetAddVisitLink.addProperty('xpath', ConditionType.EQUALS,
    '(' + secondPetRowXPath + ")[1]/td[2]//a[normalize-space(.)='Add Visit' and contains(@href, '/visits/new')]")

TestObject firstVisitUnderFirstPet = new TestObject('firstVisitUnderFirstPet')
firstVisitUnderFirstPet.addProperty('xpath', ConditionType.EQUALS,
    '(' + firstPetRowXPath + ")[1]/td[2]//table//td[normalize-space(.)='" + firstVisitDescription + "']")

TestObject firstVisitUnderSecondPet = new TestObject('firstVisitUnderSecondPet')
firstVisitUnderSecondPet.addProperty('xpath', ConditionType.EQUALS,
    '(' + secondPetRowXPath + ")[1]/td[2]//table//td[normalize-space(.)='" + firstVisitDescription + "']")

TestObject secondVisitUnderSecondPet = new TestObject('secondVisitUnderSecondPet')
secondVisitUnderSecondPet.addProperty('xpath', ConditionType.EQUALS,
    '(' + secondPetRowXPath + ")[1]/td[2]//table//td[normalize-space(.)='" + secondVisitDescription + "']")

TestObject secondVisitUnderFirstPet = new TestObject('secondVisitUnderFirstPet')
secondVisitUnderFirstPet.addProperty('xpath', ConditionType.EQUALS,
    '(' + firstPetRowXPath + ")[1]/td[2]//table//td[normalize-space(.)='" + secondVisitDescription + "']")
...
""", null)
    ...
    WebUI.verifyElementVisible(firstVisitUnderFirstPet)

    WebUI.waitForElementVisible(secondPetAddVisitLink, 10)

    WebUI.click(secondPetAddVisitLink)
    ...
    WebUI.verifyElementVisible(secondVisitUnderSecondPet)

    WebUI.verifyElementNotPresent(firstVisitUnderSecondPet, 2)

    WebUI.verifyElementNotPresent(secondVisitUnderFirstPet, 2)
} finally {
    WebUI.closeBrowser()
}
