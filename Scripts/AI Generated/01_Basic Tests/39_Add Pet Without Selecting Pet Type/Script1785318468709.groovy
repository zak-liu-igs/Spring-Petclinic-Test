...
String firstName = 'NoTypeFirst' + stamp
String lastName = 'NoTypeLast' + stamp
String address = stamp + ' No Type Street'
String city = 'NoTypeCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'DefaultTypePet' + stamp
