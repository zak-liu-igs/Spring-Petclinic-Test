...
String firstName = 'CorrectOwnerFirst' + stamp
String lastName = 'CorrectOwnerLast' + stamp
String address = stamp + ' Correct Owner Street'
String city = 'CorrectOwnerCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'CorrectOwnerPet' + stamp
