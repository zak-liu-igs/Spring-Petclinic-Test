...
""", null)
    ...
    WebUI.verifyElementPresent(xpath('spaced pet name', "//dd[normalize-space(.)='" + petName + "']"), 10)
    WebUI.verifyElementPresent(xpath('spaced bird pet',
        "//dl[.//dd[normalize-space(.)='" + petName + "']][.//dd[normalize-space(.)='bird']]"), 10)
    WebUI.verifyTextPresent('2024-01-01', false)
} finally {
    WebUI.closeBrowser()
}
