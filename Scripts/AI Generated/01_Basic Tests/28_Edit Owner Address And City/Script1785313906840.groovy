...
String firstName = 'EditFirst' + stamp
String lastName = 'EditLast' + stamp
String address = stamp + ' Original Street'
String city = 'OriginalCity'
String telephone = stamp.substring(stamp.length() - 10)
String newAddress = stamp + ' Updated Avenue'
String newCity = 'UpdatedCity'
...
try {
    ...
    WebUI.verifyTextPresent(newCity, false)
} finally {
    WebUI.closeBrowser()
}
