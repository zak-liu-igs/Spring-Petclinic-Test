...
String firstName = 'DefF' + stamp
String lastName = 'DefL' + stamp
String address = stamp + ' Default Date Street'
String city = 'DefaultCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'DefPet' + stamp
...
""", null)
    ...
    WebUI.verifyElementAttributeValue(visitDateInput, 'value', tomorrow, 10)
} finally {
    WebUI.closeBrowser()
}
