...
try {
    ...
    List<String> visitFormHistory = WebUI.findWebElements(xpath('maxVisitFormRows',
    ...
    WebUI.waitForPageLoad(10)
    List<String> ownerDetailsHistory = WebUI.findWebElements(xpath('maxOwnerRows',
        "//h2[normalize-space(.)='Pets and Visits']/following-sibling::table[1]" +
        "//tr[td[1]//dt[normalize-space(.)='Name']/following-sibling::dd[1][normalize-space(.)='Max']]" +
    ...
    WebUI.verifyEqual(ownerDetailsHistory.contains('2013-01-03 neutered'), true)
} finally {
    WebUI.closeBrowser()
}
