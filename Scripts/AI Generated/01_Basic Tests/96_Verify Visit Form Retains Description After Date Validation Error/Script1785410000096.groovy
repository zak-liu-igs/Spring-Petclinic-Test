...
String firstName = 'RetainF' + stamp
String lastName = 'RetainL' + stamp
String address = stamp + ' Retained Description Street'
String city = 'RetainCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'RetainPet' + stamp
String today = LocalDate.now().toString()
String visitDescription = 'Retained after date error ' + stamp
...
""", null)
    ...
    WebUI.verifyElementText(dateValidation, 'Visit date must be in the future')
