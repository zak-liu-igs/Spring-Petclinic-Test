...
String firstName = 'PastF' + stamp
String lastName = 'PastL' + stamp
String address = stamp + ' Past Visit Street'
String city = 'PastCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'PastPet' + stamp
String yesterday = LocalDate.now().minusDays(1).toString()
String visitDescription = 'Past date validation ' + stamp
...
""", null)
    ...
    WebUI.verifyElementAttributeValue(visitDateInput, 'value', yesterday, 10)
