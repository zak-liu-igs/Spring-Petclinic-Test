...
String firstName = 'LongFirst' + stamp
String lastName = 'LongLast' + stamp
String address = stamp + ' Long Visit Street'
String city = 'LongVisitCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'LongPet' + stamp
String visitDescription = 'Long visit record ' + stamp +
    ': examination confirmed stable vital signs, appetite, mobility, clear eyes and ears. Nutrition, hydration, exercise, medication, home monitoring, and follow-up guidance were reviewed.'
...
try {
    ...
    WebUI.verifyGreaterThanOrEqual(visitDescription.length(), 190)

    WebUI.verifyLessThanOrEqual(visitDescription.length(), 220)
