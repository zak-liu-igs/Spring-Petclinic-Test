...
String firstName = 'VisitFirst' + stamp
String lastName = 'VisitLast' + stamp
String address = stamp + ' Visit Street'
String city = 'VisitCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'VisitPet' + stamp
String visitDescription = 'Annual wellness visit ' + stamp
