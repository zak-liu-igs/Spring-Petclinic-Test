...
String firstName = 'SpecialFirst' + stamp
String lastName = 'SpecialLast' + stamp
String address = stamp + ' Special Visit Street'
String city = 'SpecialVisitCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'SpecialPet' + stamp
String visitDescription = 'Follow-up & wellness: ears/teeth #1 (' + stamp + ')'
