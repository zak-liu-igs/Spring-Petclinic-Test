...
String firstName = 'CasePetF' + stamp
String lastName = 'CasePetL' + stamp
String address = stamp + ' Case Pet Street'
String city = 'CasePetCity'
String telephone = '1' + stamp.substring(stamp.length() - 9)
String originalPetName = 'CasePet' + stamp
String differentlyCasedPetName = originalPetName.toLowerCase()
...
try {
    ...
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_PetName'), originalPetName)
...
""", null)
    ...
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_PetName'),
        differentlyCasedPetName)
...
""", null)
    ...
    WebUI.selectOptionByLabel(findTestObject('Page_PetClinic  a Spring Framework demonstration/select_Type'), 'bird', false)
    ...
    WebUI.verifyElementAttributeValue(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_PetName'),
        'value', differentlyCasedPetName, 10)
} finally {
    WebUI.closeBrowser()
}
