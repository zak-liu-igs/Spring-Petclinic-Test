...
String firstName = 'FormF' + stamp
String lastName = 'FormL' + stamp
String fullName = firstName + ' ' + lastName
String address = stamp + ' Form Street'
String city = 'FormCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'FormPet' + stamp
...
TestObject petInformationRow = new TestObject('petInformationRow')
petInformationRow.addProperty('xpath', ConditionType.EQUALS,
    "//h2[normalize-space(.)='New Visit']/following::table[1][" +
    ".//th[normalize-space(.)='Name'] and .//th[normalize-space(.)='Birth Date'] and " +
    ".//th[normalize-space(.)='Type'] and .//th[normalize-space(.)='Owner']]//tr[" +
    "td[1][normalize-space(.)='" + petName + "'] and td[2][normalize-space(.)='2024-01-01'] and " +
    "td[3][normalize-space(.)='dog'] and td[4][normalize-space(.)='" + fullName + "']]")
...
""", null)
    ...
    WebUI.verifyElementVisible(petInformationRow)

    WebUI.verifyElementVisible(visitDateInput)

    WebUI.verifyElementAttributeValue(visitDateInput, 'type', 'date', 10)

    WebUI.verifyElementVisible(findTestObject('Page_PetClinic  a Spring Framework demonstration/Page_PetClinic  a Spring Framework demonstration/input_Description'))

    WebUI.verifyElementAttributeValue(findTestObject('Page_PetClinic  a Spring Framework demonstration/Page_PetClinic  a Spring Framework demonstration/input_Description'),
        'id', 'description', 10)
} finally {
    WebUI.closeBrowser()
}
