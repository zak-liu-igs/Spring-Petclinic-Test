...
String firstName = 'HistoryFirst' + stamp
String lastName = 'HistoryLast' + stamp
String address = stamp + ' Visit History Street'
String city = 'HistoryCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'HistoryPet' + stamp
String visitDescription = 'History verification visit ' + stamp
