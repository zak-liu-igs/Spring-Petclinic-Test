...
veterinarianRow.addProperty('xpath', ConditionType.EQUALS,
...
noSpecialty.addProperty('xpath', ConditionType.EQUALS,
    "//table[@id='vets']/tbody/tr[td[1][normalize-space(.)='James Carter']]/td[2]/span[normalize-space(.)='none']")
...
try {
    ...
    WebUI.verifyElementVisible(noSpecialty)
