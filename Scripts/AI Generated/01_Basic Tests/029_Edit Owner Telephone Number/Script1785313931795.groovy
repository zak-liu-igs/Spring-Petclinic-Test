...
String firstName = 'PhoneFirst' + stamp
String lastName = 'PhoneLast' + stamp
String address = stamp + ' Phone Street'
String city = 'PhoneCity'
String telephone = stamp.substring(stamp.length() - 10)
String newTelephone = ('9' + stamp).substring(0, 10)
...
try {
    ...
    WebUI.verifyTextPresent(newTelephone, false)
} finally {
    WebUI.closeBrowser()
}
