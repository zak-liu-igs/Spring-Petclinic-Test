...
String firstName = 'Exact' + token.substring(token.length() - 6)
String lastName = 'Search' + token
...
def fillOwner = {
    ...
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Address'), '103 Exact Search Avenue')
