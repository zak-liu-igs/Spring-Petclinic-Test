...
String firstName = 'DuplicateFirst' + stamp
String lastName = 'DuplicateLast' + stamp
String address = stamp + ' Duplicate Visit Street'
String city = 'DuplicateCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'DuplicatePet' + stamp
String visitDescription = 'Repeated visit description ' + stamp
...
TestObject duplicateSavedVisits = new TestObject('duplicateSavedVisits')
duplicateSavedVisits.addProperty('xpath', ConditionType.EQUALS,
...
""", null)
    ...
    int matchingVisitCount = WebUI.findWebElements(duplicateSavedVisits, 10).size()

    WebUI.verifyEqual(matchingVisitCount, 2)
} finally {
    WebUI.closeBrowser()
}
