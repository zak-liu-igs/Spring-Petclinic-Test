...
String firstName = 'MaxPetF' + stamp
String lastName = 'MaxPetL' + stamp
String address = stamp + ' Maximum Pet Street'
String city = 'MaximumPetCity'
String telephone = '7' + stamp.substring(stamp.length() - 9)
String petName = 'Maximum' + stamp + 'XXXXXXXXXX'
String petType = 'dog'
...
try {
    ...
    WebUI.verifyEqual(petName.length(), 30)
