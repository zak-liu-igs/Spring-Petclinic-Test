...
try {
    ...
    WebUI.verifyTextPresent('Find Owners', false)

    WebUI.verifyElementPresent(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_lastName'), 10)

    WebUI.verifyElementPresent(findTestObject('Page_PetClinic  a Spring Framework demonstration/button_Find Owner'), 10)
} finally {
    WebUI.closeBrowser()
}
