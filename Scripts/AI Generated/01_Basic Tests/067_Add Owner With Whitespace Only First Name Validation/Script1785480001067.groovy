...
String lastName = 'BlankF' + stamp
String address = stamp + ' Validation Street'
String city = 'ValidationCity'
String telephone = '4' + stamp.substring(stamp.length() - 9)

TestObject firstNameValidation = new TestObject('firstNameValidation')
firstNameValidation.addProperty('xpath', ConditionType.EQUALS,
    ...
    "normalize-space(.)='must not be blank']")
...
try {
    ...
    WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_First Name'), whitespaceFirstName)
    ...
    WebUI.waitForElementVisible(firstNameValidation, 10)

    WebUI.verifyElementVisible(firstNameValidation)

    WebUI.verifyElementAttributeValue(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_First Name'),
        'value', whitespaceFirstName, 10)
