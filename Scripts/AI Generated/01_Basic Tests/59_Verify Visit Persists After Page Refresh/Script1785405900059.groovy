...
String firstName = 'Persist' + stamp
String lastName = 'VP' + stamp
String address = stamp + ' Persistence Street'
String city = 'PersistCity'
String telephone = stamp.substring(stamp.length() - 10)
String petName = 'Keep' + stamp
String visitDescription = 'Persistent visit ' + stamp
...
visitDateInput.addProperty('xpath', ConditionType.EQUALS, "//form//input[@id='date' and @name='date']")
...
""", null)
    ...
    TestObject savedVisitRow = new TestObject('savedVisitRow')
    savedVisitRow.addProperty('xpath', ConditionType.EQUALS,
        '(' + petRowXPath + ")[1]/td[2]//table//tr[td[1][normalize-space(.)='" + visitDate +
        "'] and td[2][normalize-space(.)='" + visitDescription + "']]")

    WebUI.verifyElementVisible(savedVisitRow)
