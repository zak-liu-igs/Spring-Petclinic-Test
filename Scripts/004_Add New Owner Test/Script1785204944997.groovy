...
WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_First Name'), 'Test')
...
WebUI.setText(findTestObject('Page_PetClinic  a Spring Framework demonstration/input_Telephone'), '0912345678')

WebUI.click(findTestObject('Page_PetClinic  a Spring Framework demonstration/button_Add Owner'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Test Davis', false)
